package mx.edu.potros.app_firebase_hiram;
...
public class MainActivity extends AppCompatActivity {
        ...
        btnbus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(txtid.getText().toString().trim().isEmpty()){
                    ...
                    DatabaseReference dbref = db.getReference(Luchador.class.getSimpleName()); // DatabaseReference dbref = db.getReference().child("Luchador");
            ...
            public void onClick(View v) {
                if(txtid.getText().toString().trim().isEmpty()
                    ...
                    dbref.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        @Override
                        public void onCancelled(@NonNull DatabaseError error) {
                            Toast.makeText(MainActivity.this, "Error Al Modificar al Luchador!!", Toast.LENGTH_SHORT).show();
                        }
                    });
    ...
    } // Cierra el metodo botonModificar
            ...
            public void onClick(View v) {
                ...
                if(txtid.getText().toString().trim().isEmpty()
                    ...
                    dbref.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        @Override
                        public void onCancelled(@NonNull DatabaseError error) {
                            Toast.makeText(MainActivity.this, "Error al registrar al Luchador!!", Toast.LENGTH_SHORT).show();
                        }
                    });
    ...
    }// Cierra metodo del botonRegistrar

    private void listarLuchadores(){
        FirebaseDatabase db = FirebaseDatabase.getInstance();
        DatabaseReference dbref = db.getReference(Luchador.class.getSimpleName());

        ArrayList<Luchador> listLuc = new ArrayList<Luchador>();
        ArrayAdapter<Luchador> ada = new ArrayAdapter<Luchador>(MainActivity.this, android.R.layout.simple_list_item_1, listLuc);
        ...
        lvDatos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Luchador luc = listLuc.get(position);
                ...
                if(txtid.getText().toString().trim().isEmpty()){
                    ...
                    dbref.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if(aux.equalsIgnoreCase(x.child("id").getValue().toString())){
                                    ...
                                    a.setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            listarLuchadores();
                                            Toast.makeText(MainActivity.this, "Luchador Eliminado Correctamente!!", Toast.LENGTH_SHORT).show();
                                            txtid.setText("");
                                            txtnom.setText("");
                                        }
                                    });
                            ...
                            if(res[0] == false){
                                ocultarTeclado();
                                Toast.makeText(MainActivity.this, "ID ("+aux+") No Encontrado. Imposible Elimininar!!", Toast.LENGTH_SHORT).show();
                            }
                        }
